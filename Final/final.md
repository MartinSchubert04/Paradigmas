...
>
> - Es deterministra, dado el un input siempre retorna el mismo output
> - No existen estructuras de control (for / while). Se itera mediante recusividad
> - No hay asignacion destructiva ni estado mutable
> - Funciones puras y con transparencia referencial
> - Las funciones son de primera clase (orden superior)
> - No produce efectos secundarios
>
> En haskell
>
> - La evaluacion es Lazy
> - Las TypeClasses agregan polimorfismo ad-hoc sobre el calculo lambda original (que no tiene nocion de sobrecarga), permite definicion de funciones/operadores (+, ==, Show) con implementaciones distintas según el tipo, siempre que ese tipo sea instancia declarada de la clase, verificado en tiempo de compilación
>
> Estos lenguajes terminaron convergiendo o combinandose con el paradigma orientado a objetos creando asi lenguajes multparadigma. Casos como Scala que los utiliza de forma nativa.
